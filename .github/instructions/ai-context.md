# AI Context & Instructions for ha-boulderwelt

## 🧬 Project DNA
**Repository:** `ha-boulderwelt`
**Type:** Home Assistant Custom Integration
**Domain:** `boulderwelt`
**Description:** Monitor the real-time occupancy of your favorite **Boulderwelt** hall directly in Home Assistant. Plan your next session when it's less crowded!
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/boulderwelt/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
